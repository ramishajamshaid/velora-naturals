        ...
        <>
            ...
            <main>
                ...
                <section id='about-us' className="w-full py-8 px-4 pt-16">
                    <div className="w-full max-w-250 mx-auto flex justify-center items-center gap-18">
                        ...
                        <div className="flex flex-col justify-center items-start gap-4">
                            ...
                            <a href='#ingredients' className="bg-(--tertiary-accent) text-white text-[12px] px-5 mt-4 tablet:px-8 py-3 tablet:text-[14px] rounded-lg font-body flex justify-center items-center gap-3 hover:opacity-95 transition-opacity duration-300 cursor-pointer">
                        ...
                        <div className="grid xs:grid-cols-2 laptop:grid-cols-4 gap-6">
                            <div className="flex flex-row-reverse laptop:flex-col justify-start items-center rounded-2xl overflow-hidden bg-(--secondary-light) border border-(--text-light-muted)">
                                ...
                                <div className="flex flex-col justify-center items-start p-3">
                                    <h3 className="relative text-[0.95rem] xs:text-[1.1rem] tablet:text-[1.4rem] text-(--primary-dark) font-body pb-2">Amla</h3>
                                    <p className="text-[11px] xs:text-[12px] tablet:text-[14px] font-body text-(--secondary-dark) leading-4 tablet:leading-5 -mt-1.5">Strengthens roots and supports healthy growth.</p>
                                </div>
                            </div>
                            <div className="flex flex-row-reverse laptop:flex-col justify-start items-center rounded-2xl overflow-hidden bg-(--secondary-light) border border-(--text-light-muted)">
                                <div className="w-full aspect-3/2 xs:aspect-4/3">
                                ...
                                <div className="flex flex-col justify-center items-start p-3">
                                    <h3 className="relative text-[0.95rem] xs:text-[1.1rem] tablet:text-[1.4rem] text-(--primary-dark) font-body pb-2">Rosemary</h3>
                                    <p className="text-[11px] xs:text-[12px] tablet:text-[14px] font-body text-(--secondary-dark) leading-4 tablet:leading-5 -mt-1.5">Boosts scalp health and promotes stronger hair.</p>
                                </div>
                            </div>
                            <div className="flex flex-row-reverse laptop:flex-col justify-start items-center rounded-2xl overflow-hidden bg-(--secondary-light) border border-(--text-light-muted)">
                                <div className="w-full aspect-3/2 xs:aspect-4/3">
                                ...
                                <div className="flex flex-col justify-center items-start p-3">
                                    <h3 className="relative text-[0.95rem] xs:text-[1.1rem] tablet:text-[1.4rem] text-(--primary-dark) font-body pb-2">Fenugreek</h3>
                                    <p className="text-[11px] xs:text-[12px] tablet:text-[14px] font-body text-(--secondary-dark) leading-4 tablet:leading-5 -mt-1.5">Nourishes hair and helps reduce breakage.</p>
                                </div>
                            </div>
                            <div className="flex flex-row-reverse laptop:flex-col justify-start items-center rounded-2xl overflow-hidden bg-(--secondary-light) border border-(--text-light-muted)">
                                <div className="w-full aspect-3/2 xs:aspect-4/3">
                                ...
                                <div className="flex flex-col justify-center items-start p-3">
                                    <h3 className="relative text-[0.95rem] xs:text-[1.1rem] tablet:text-[1.4rem] text-(--primary-dark) font-body pb-2">Aloe Vera</h3>
                                    <p className="text-[11px] xs:text-[12px] tablet:text-[14px] font-body text-(--secondary-dark) leading-4 tablet:leading-5 -mt-1.5">Soothes the scalp and restores natural moisture.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id='use' className="w-full py-8 px-4 bg-(--primary-light)">
                    <div className="w-full max-w-250 mx-auto flex flex-col justify-center items-center gap-16 mt-4">
                        <div className="flex flex-col justify-center items-center">
                            <h2 className="text-[2.2rem] xs:text-[2.5rem] text-center text-(--primary-dark) font-display leading-14 mb-2">
                                How to Use?
                            </h2>
                        ...
                        <div className="grid xs:grid-cols-3 gap-4">
                            <div className="flex flex-col justify-start items-center">
                                ...
                                <div className="flex flex-col justify-center items-center p-3">
                                    <h3 className="text-center relative text-[0.95rem] xs:text-[1.1rem] tablet:text-[1.4rem] text-(--primary-dark) font-body pb-2">Wet Hair</h3>
                                    <p className="text-center text-[11px] xs:text-[12px] tablet:text-[14px] font-body text-(--secondary-dark) leading-4 tablet:leading-5 -mt-1.5">Completely Wet your Hair with Lukewarm Water.</p>
                                </div>
                            </div>
                            <div className="flex flex-col justify-start items-center">
                                <div className="relative w-28 h-28 tablet:w-34 tablet:h-34">
                                ...
                                <div className="flex flex-col justify-center items-center p-3">
                                    <h3 className="text-center relative text-[0.95rem] xs:text-[1.1rem] tablet:text-[1.4rem] text-(--primary-dark) font-body pb-2">Lather & Massage</h3>
                                    <p className="text-center text-[11px] xs:text-[12px] tablet:text-[14px] font-body text-(--secondary-dark) leading-4 tablet:leading-5 -mt-1.5">Apply Shampoo and Massage into scalp. and work with lather.</p>
                                </div>
                            </div>
                            <div className="flex flex-col justify-start items-center">
                                <div className="relative w-28 h-28 tablet:w-34 tablet:h-34">
                                ...
                                <div className="flex flex-col justify-center items-center p-3">
                                    <h3 className="text-center relative text-[0.95rem] xs:text-[1.1rem] tablet:text-[1.4rem] text-(--primary-dark) font-body pb-2">Rinse Thoroughly</h3>
                                    <p className="text-center text-[11px] xs:text-[12px] tablet:text-[14px] font-body text-(--secondary-dark) leading-4 tablet:leading-5 -mt-1.5">Rinse well with lukewarm water. Apply Conditioner if needed.</p>
                                </div>
                            </div>
                        </div>
                    </div>
