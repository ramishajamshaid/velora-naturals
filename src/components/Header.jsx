...
import { Menu, Sprout, FlaskConical, Rabbit, Sparkles } from 'lucide-react'
...
function Header() {
    return (
        <>
            <div className="bg-(--secondary-light) overflow-hidden min-h-10 p-3 w-full flex">
            ...
            <header className="max-w-350 mx-auto min-h-18 bg-(--primary-light) flex justify-between items-center w-full py-3 px-6 tablet:px-8">
                <button className="flex tablet:hidden text-(--secondary-dark) hover:text-(--tertiary-accent) transition-all cursor-pointer">
                    <Menu />
                </button>
                <div className="flex flex-col justify-center items-center leading-5 xs:leading-6 mt-2 font-body">
                ...
                <nav className="hidden tablet:flex items-center gap-10 font-body text-[0.95rem] text-(--secondary-dark)">
                    ...
                    <a to="" className="hover:text-(--tertiary-accent) transition-all cursor-pointer">Reviews</a>
                    <a to="" className="hover:text-(--tertiary-accent) transition-all cursor-pointer">Shop</a>
                </nav>
